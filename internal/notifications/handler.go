...
func (h *Handler) Create(c *gin.Context) {
	...
	if decoder.Decode(&request) != nil {
		httpx.WriteError(w, r, 400, httpx.Error{Code: "VALIDATION_ERROR", Message: "invalid notification"})
		return
	}
...
func (h *Handler) Read(c *gin.Context) {
	...
	if e != nil {
		httpx.WriteError(w, r, 404, httpx.Error{Code: "NOT_FOUND", Message: "notification not found"})
		return
	}
	item, e := h.service.Read(r.Context(), id)
	if e != nil {
		httpx.WriteError(w, r, 404, httpx.Error{Code: "NOT_FOUND", Message: "notification not found"})
		return
	}
